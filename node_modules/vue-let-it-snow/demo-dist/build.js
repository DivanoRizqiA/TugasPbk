...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dist_vue_let_it_snow_umd__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dist_vue_let_it_snow_umd___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__dist_vue_let_it_snow_umd__);


// import LetItSnow from '../src/index';


__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].use(__WEBPACK_IMPORTED_MODULE_2__dist_vue_let_it_snow_umd___default.a);
...
// module
exports.push([module.i, "body,html{height:100%}body{background:#090b44;background:-moz-radial-gradient(center,ellipse cover,#090b44 0,#00001c 100%);background:-webkit-gradient(radial,center center,0,center center,100%,color-stop(0,#090b44),color-stop(100%,#00001c));background:-webkit-radial-gradient(center,ellipse cover,#090b44 0,#00001c 100%);background:-o-radial-gradient(center,ellipse cover,#090b44 0,#00001c 100%);background:-ms-radial-gradient(center,ellipse cover,#090b44 0,#00001c 100%);background:radial-gradient(ellipse at center,#090b44 0,#00001c 100%);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=\"#090b44\",endColorstr=\"#00001c\",GradientType=1);padding:0;text-align:center;font-family:open sans;position:relative;margin:0;padding-bottom:50px}.wrapper{height:auto!important;height:100%;margin:0 auto;overflow:hidden}a{text-decoration:none}h1,h2{width:100%;float:left}h1{margin-top:100px;color:#1d3185;text-shadow:0 1px 5px rgba(0,0,0,.5);margin-bottom:5px;font-size:70px;letter-spacing:-4px}h2{color:#3c487a;margin-top:0;margin-bottom:10px}.pointer,h2{font-weight:700}.pointer{position:fixed;bottom:10px;left:50%;margin-left:-245px;color:#2744be;font-family:Open Sans,cursive;font-size:14px;margin-top:15px}pre{margin:80px auto}pre code{padding:35px;border-radius:5px;font-size:15px;background:rgba(0,0,0,.1);border:5px solid rgba(0,0,0,.05);max-width:500px}.main{margin:0 auto}.main,.main h1{float:left;width:100%}.main h1{padding:20px 50px;font-size:60px;box-sizing:border-box;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;font-weight:100;margin:0;padding-top:25px;font-family:Pacifico;letter-spacing:2px}.main h1.demo1{background:#1abc9c}.reload.bell{font-size:12px;padding:20px;width:45px;text-align:center;height:47px;border-radius:50px;-webkit-border-radius:50px;-moz-border-radius:50px}.reload.bell #notification{font-size:25px;line-height:140%}.btn,.reload{border:4px solid #a2261e;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;background:#cc3126;display:inline-block;line-height:100%;padding:.7em;text-decoration:none;color:#2744be;width:100px;line-height:140%;font-size:17px;font-family:open sans;font-weight:700}.reload:hover{background:#a2261e}.btn{width:200px;color:#2744be;border:none;margin-left:10px;background:rgba(0,0,0,.31)}.clear{width:auto}.btn:hover{background:rgba(0,0,0,.5)}.btns{width:410px;margin:50px auto}.credit{font-style:italic;text-align:center;color:#1d3185;padding:10px;margin:0 0 40px;float:left;width:100%}.credit a{text-decoration:none}.back,.credit a{color:#2744be;font-weight:700}.back{position:absolute;top:0;left:0;text-align:center;display:block;padding:7px;width:100%;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;background:rgba(0,0,0,.35);font-size:13px;-webkit-transition:all .2s ease-out;-moz-transition:all .2s ease-out;-o-transition:all .2s ease-out;transition:all .2s ease-out}.back:hover{background:rgba(0,0,0,.85)}.header{position:relative}", ""]);
...
/* WEBPACK VAR INJECTION */(function(global) {(function (global, factory) {
     true ? factory(exports) : typeof define === 'function' && define.amd ? define(['exports'], factory) : factory(global.VueLetItSnow = {});
    ...
    var component = { render: function () {
            var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _vm.myShow ? _c('div', { ref: "wrap", staticClass: "snow-wrap", class: { 'events-all': _vm.interaction, 'hide': _vm.toHide } }, [_vm._l(_vm.images, function (img, index) {
                return _c('img', { key: index, staticClass: "lis_flake", staticStyle: { "display": "none" }, attrs: { "src": img } });
            }), _vm._v(" "), _c('canvas', { ref: "canvas", attrs: { "width": "100%", "height": "100%" } })], 2) : _vm._e();
        }, staticRenderFns: [], _scopeId: 'data-v-8db57eba',
        name: 'let-it-snow',
        data: function data() {
            return {
                flakes: [],
